    ...
    <html lang="ko" className={`${notoSansKR.variable} scroll-smooth`} data-scroll-behavior="smooth">
      ...
      <body className="min-h-screen flex flex-col antialiased" suppressHydrationWarning>
        ...
        <Script id="meta-pixel-2" strategy="afterInteractive">{`
          ...
          fbq('init','2442810859464150');fbq('track','PageView');
        `}</Script>
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <noscript><img height="1" width="1" style={{display:"none"}} alt="" src="https://www.facebook.com/tr?id=2442810859464150&ev=PageView&noscript=1" /></noscript>
        <Script id="meta-pixel" strategy="afterInteractive">{`
          ...
          t.src=v;s=b.getElementsByTagName(e)[0];s.parentNode.insertBefore(t,s)}
          (window,document,'script','https://connect.facebook.net/en_US/fbevents.js');
          fbq('init','2430087854084411');fbq('track','PageView');
        `}</Script>
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <noscript><img height="1" width="1" style={{display:"none"}} alt="" src="https://www.facebook.com/tr?id=2430087854084411&ev=PageView&noscript=1" /></noscript>
      </body>
    </html>
  );
}
